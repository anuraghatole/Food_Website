    ...
    <>
      <div className=" max-w-[1640px] mx-auto flex justify-between items-center p-4">
        ...
        <button className="  hidden  md:flex border-white border-2 p-2 rounded-full bg-black text-white ">
          <BsFillCartFill size={23} className="mr-2" />
          Cart
        </button>
          ...
          <nav>
            <ul className="flex flex-col p-4 text-gray-800">
              <li className="flex text-xl py-4">
                <TbTruckDelivery size={30} className="mr-3" /> Orders
              </li>
              <li className="flex text-xl py-4">
                <MdFavorite size={30} className="mr-3" />
                Favourites
              </li>
              <li className="flex text-xl py-4">
                <FaWallet size={30} className="mr-3" /> Wallet
              </li>
              <li className="flex text-xl py-4">
                <MdHelp size={30} className="mr-3" />
                Help
              </li>
              <li className="flex text-xl py-4">
                <AiFillTag size={30} className="mr-3" /> Promotions
              </li>
              <li className="flex text-xl py-4">
                <BsFillSaveFill size={30} className="mr-3" />
                Best One
              </li>
              <li className="flex text-xl py-4">
                <FaUserFriends size={30} className="mr-3" /> Invite Friends
              </li>
            </ul>
          </nav>
        </div>
